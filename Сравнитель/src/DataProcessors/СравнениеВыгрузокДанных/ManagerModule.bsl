...
Процедура СравнитьДанные(СравнениеДанныхСсылка) Экспорт
	...
	Попытка
		...
		#Если _Рябов Тогда
			ДокументОбъект = Документы.СравнениеДанных.ПустаяСсылка().ПолучитьОбъект();
		#КонецЕсли
		
		БлокировкаДанных = Новый БлокировкаДанных;
		
		//ЭлементБлокировки = БлокировкаДанных.Добавить("РегистрСведений.СравненияДанных");
		//ЭлементБлокировки.УстановитьЗначение("Регистратор", СравнениеДанныхСсылка);
